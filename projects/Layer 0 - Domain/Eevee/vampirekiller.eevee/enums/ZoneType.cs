...
namespace souchy.celebi.eevee.enums
{
    ...
    {
        public ZoneSize sizeParams;
        public float ringWidth { get => sizeParams.ringWidth; set => sizeParams.ringWidth = value; }
    }
    ...
    {
        public float length { get => sizeParams.radius; set => sizeParams.radius = value; }
    }
    // circle O, square [], halfcircle /_\, v  /\
    public class ZoneSizeRadius : IZoneSize
    {
        public float radius { get => sizeParams.radius; set => sizeParams.radius = value; }
    }
    // cross, xcross, star, rectangle, ellipse, ellipseHalf
    public class ZoneSizeRadius2 : IZoneSize
    {
        public float radiusForward { get => sizeParams.radius; set => sizeParams.radius = value; }
        public float radiusSide { get => sizeParams.sideRadius; set => sizeParams.sideRadius = value; }
    }
